...
<x-app-layout>
    ...
    @if (Auth::user()->email == 'admin@gmail.com' && Auth::user()->name == 'admin')
        <div class="container my-4">
            ...
            <p class="text-center mb-4">Here are the feedback given by all the guests.</p>
            <form id="filter">
                <select id="feedback">
                    <option value=""></option>
            ...
            <table class="table table-bordered table-hover mt-4" id="data">
            ...
            <a href="{{ route('feedback.download') }}" id='export' type="button" class="btn btn-secondary">Export</a>
        </div>
    @else
